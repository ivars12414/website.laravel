            ...
            <div class="settings__wrapper">
                ...
                <div class="settings__block">
                    <form class="form" data-form="profile">
                        ...
                        <div class="form__block">
                            <label for="sign-up-phone-code" class="label">{!! returnWord('Phone', WORDS_INTERFACE) !!}
                                :</label>
                ...
                <div class="settings__block">
                    <form class="form" data-form="change-password">
                        <div class="block__title"><strong>{!! returnWord('Password change', WORDS_PROJECT) !!}</strong>
                        </div>
                        ...
                        <div class="form__block">
                            <label for="settings-current-password"
                                   class="label">{!! returnWord('Current password', WORDS_INTERFACE) !!}:</label>
                            <input type="password" class="input" id="settings-current-password" name="password_0">
                        </div>
                        ...
                        <div class="form__block">
                            <label for="settings-confirm-new-password"
                                   class="label">{!! returnWord('Confirm new password', WORDS_INTERFACE) !!}:</label>
                            <input type="password" class="input" id="settings-confirm-new-password" name="password_2">
                        </div>
