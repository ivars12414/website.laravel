...
<div class="remodal__body">
    <form class="form js-activation-code-form" data-form="activation-code" method="post" action="#"
          onsubmit="return false;">
        @csrf
        <input type="hidden" name="client_mail" id="client_mail"
               value="{{ e($mail) }}">
        <div class="block__title js-title"><strong>{!! returnWord('Activation', WORDS_INTERFACE) !!}</strong></div>

        <div class="js-alert alert" data-form="activation-code" data-group="default" style="display: none"></div>

        <div class="form__block">
            <label for="activation-code" class="label">{!! returnWord('Activation code', WORDS_INTERFACE) !!}:</label>
        ...
        <div class="form__block">
            <div id="countdown-wrapper">
                {!! returnWord('New code available after', WORDS_INTERFACE) !!}&nbsp;<span
                    id="countdown">{{ $seconds }}</span>&nbsp;{!! returnWord('s.', WORDS_INTERFACE) !!}
            </div>
        </div>
        ...
        <div class="form__block">
            <button type="submit" class="btn btn--main">
                {!! returnWord('Submit', WORDS_INTERFACE) !!}
            </button>
        </div>
    </form>
</div>
